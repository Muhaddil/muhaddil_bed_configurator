...
Locales['es'] = {
    ...
    ['label_fine_height'] = 'ALTURA FINA',
    ['control_fine_height_desc'] = 'Re Pág / Av Pág',
    ['label_snap_surface'] = 'SNAP SUP.',
    ['control_snap_surface_key'] = 'F1',
    ['label_grid_snap'] = 'GRID SNAP',
    ['control_grid_snap_key'] = 'F2',
    ['label_debug_info'] = 'DEBUG',
    ['control_debug_info_key'] = 'F3',
...
Locales['en'] = {
    ...
    ['label_fine_height'] = 'FINE HEIGHT',
    ['control_fine_height_desc'] = 'PgUp / PgDown',
    ['label_snap_surface'] = 'SNAP SURF.',
    ['control_snap_surface_key'] = 'F1',
    ['label_grid_snap'] = 'GRID SNAP',
    ['control_grid_snap_key'] = 'F2',
    ['label_debug_info'] = 'DEBUG',
